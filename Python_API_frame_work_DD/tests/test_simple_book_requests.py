...
class Test_Simple_books_class(Rest_api_methods):
    ...
    Rest_api_methods.END_payload_file = r"..\\Python_API_frame_work_DD\json_files\pay_load_file.json"
    Rest_api_methods.test_data_file_path = r"..\\Python_API_frame_work_DD\json_files\test_data.json"
