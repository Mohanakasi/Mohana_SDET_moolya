...
from python_appium_data_driven.pages.add_to_cart import pom_general_store
# from pytest import fixture
@pytest.mark.usefixtures("setup")
class Test_gen_store_cart:

    def test_adding_shoes_to_cart(self, setup):
        gen_st_obj = pom_general_store(setup, r"..\\python_appium_data_driven\Data_setup\gen_store_test_data.xlsx", "general store", 'A', 'B')
